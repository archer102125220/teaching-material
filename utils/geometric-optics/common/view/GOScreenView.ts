...
import ScreenView, { type ScreenViewOptions } from '../../../joist/ScreenView';
import ModelViewTransform2 from '../../../phetcommon/view/ModelViewTransform2';
import ResetAllButton from '../../../scenery-phet/buttons/ResetAllButton';
import MagnifyingGlassZoomButtonGroup from '../../../scenery-phet/MagnifyingGlassZoomButtonGroup';
import { HBox, Node, Rectangle } from '../../../scenery/imports';
import geometricOptics from '../../geometricOptics';
import GOConstants from '../GOConstants';
import GOQueryParameters from '../GOQueryParameters';
import GOModel from '../model/GOModel';
import GOControlPanel from './GOControlPanel';
import OpticSurfaceTypeRadioButtonGroup from './OpticSurfaceTypeRadioButtonGroup';
import OpticalObjectChoiceComboBox from './OpticalObjectChoiceComboBox';
import LightPropagationToggleButton from './LightPropagationToggleButton';
import VisibleProperties from './VisibleProperties';
import FramedSceneNode from './FramedSceneNode';
import GORulerNode from './tools/GORulerNode';
import GOToolboxNode from './tools/GOToolboxNode';
import FramedLabelsNode from './labels/FramedLabelsNode';
import ArrowSceneNode from './ArrowSceneNode';
import ArrowLabelsNode from './labels/ArrowLabelsNode';
import LightSceneNode from './LightSceneNode';
import LightLabelsNode from './labels/LightLabelsNode';
import GOSceneNode, { type GOSceneNodeOptions } from './GOSceneNode';
import optionize from '../../../phet-core/optionize';
import ObjectDragModeToggleButton from './ObjectDragModeToggleButton';
import type TProperty from '../../../axon/TProperty';
import type PickRequired from '../../../phet-core/types/PickRequired';
import NumberIO from '../../../tandem/types/NumberIO';
import PositionMarkerNode from './tools/PositionMarkerNode';
import { type ObjectDragMode, ObjectDragModeValues } from './ObjectDragMode';
import BooleanIO from '../../../tandem/types/BooleanIO';
import { type GOSimOptions } from '../../GOSim';
import GOToolNode from './tools/GOToolNode';
