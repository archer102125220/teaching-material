  ...
  public constructor(scene: LightScene,
    ...
    scene.lens.opticSurfaceTypeProperty.link(opticSurfaceType => {
      if (opticSurfaceType === 'convex') {
        ...
        window.assert && window.assert(this.toolJumpPoints.length === commonJumpPoints.length + convexJumpPoints.length);
      }
      else {
        ...
        window.assert && window.assert(this.toolJumpPoints.length === commonJumpPoints.length);
      }
    });
