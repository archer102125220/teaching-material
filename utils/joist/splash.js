...
export function splash(container) {
  ...
  if (window.PHET_SPLASH_DATA_URI) {
    ...
    splashImage.src = '/img/adapted-from-phet/splash.svg';
  }
  ...
  zoomEvents.forEach((zoomEvent) =>
    window.addEventListener(zoomEvent, preventZoom, {
