...
export default class Mouse extends Pointer {
  ...
  public override down(event: Event): void {
    window.assert && window.assert(event instanceof MouseEvent); // eslint-disable-line no-simple-type-checking-assertions
  ...
  public wheel(event: Event): void {
    window.assert && window.assert(event instanceof WheelEvent); // eslint-disable-line no-simple-type-checking-assertions
