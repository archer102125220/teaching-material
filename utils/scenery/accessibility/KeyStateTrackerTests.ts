...
import KeyStateTracker from '@/utils/scenery/accessibility/KeyStateTracker';
...
QUnit.test('test tracking with time', assert => {
...
QUnit.test('KeyStateTracker.enabled', assert => {
