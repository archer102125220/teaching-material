 ...
 * Note: This is currently implemented using large numbers, it should be rewritten to work in any coordinate frame, possibly using window.phet.kite.Shape.plane()
 * TODO: Implement using infinite geometry https://github.com/phetsims/scenery/issues/1581
 *
 * @author Sam Reid (PhET Interactive Simulations)
 */

import { Rectangle, type RectangleOptions, scenery } from '@/utils/scenery/imports';
