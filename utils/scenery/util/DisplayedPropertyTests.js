...
import DisplayedProperty from '@/utils/scenery/util/DisplayedProperty';
...
QUnit.test('basics', (assert) => {
  ...
  assert.ok(
    aDisplayedProperty.value === false,
    'connected, parent not visible, not displayed'
  );
  ...
  assert.ok(
    aDisplayedProperty.value === false,
    'connected, not visible, not displayed'
  );
...
QUnit.test('pdom visibility', (assert) => {
  ...
  assert.ok(
    aDisplayedProperty.value === true,
    'visible even with pdomOrder, displayed'
  );
