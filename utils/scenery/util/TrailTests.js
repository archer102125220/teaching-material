...
QUnit.test(
  'depthFirstUntil depthFirstUntil with subtree skipping',
  (assert) => {
    const node = createTestNodeTree();
    node.children[0].children[2].visible = false;
    node.children[0].children[3].visible = false;
    new TrailPointer(new Trail(node), true).depthFirstUntil(
      new TrailPointer(new Trail(node), false),
      (pointer) => {
...
QUnit.test('TrailPointer render comparison', (assert) => {
  ...
  const pointers = [
    ...
    new TrailPointer(
      node.children[0].children[3].children[0].children[0].getUniqueTrail(),
      true
    ),
    new TrailPointer(
      node.children[0].children[3].children[0].children[0].getUniqueTrail(),
    ...
    new TrailPointer(
      node.children[0].children[3].children[1].getUniqueTrail(),
      true
    ),
    new TrailPointer(
      node.children[0].children[3].children[1].getUniqueTrail(),
