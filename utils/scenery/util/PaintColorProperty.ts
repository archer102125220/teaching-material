 ...
 * ```
 *   const color = new window.phet.scenery.Color( 'red' );
 *   const fill = new window.phet.axon.Property( color );
 *   const paintColorProperty = new window.phet.scenery.PaintColorProperty( fill );
 *
