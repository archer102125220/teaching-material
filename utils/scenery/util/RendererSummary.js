...
class RendererSummary {
  ...
  static summaryBitmaskForNodeSelf(node) {
    ...
    // NOTE: If changing, see Instance.updateRenderingState
    if (
      !requiresSplit && // Can't have a single SVG element if we are split
