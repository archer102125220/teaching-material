 ...
 *
 * Examples:
 * new window.phet.scenery.Font().font                      // "10px sans-serif" (the default)
 * new window.phet.scenery.Font( { family: 'serif' } ).font // "10px serif"
 * new window.phet.scenery.Font( { weight: 'bold' } ).font  // "bold 10px sans-serif"
 * new window.phet.scenery.Font( { size: 16 } ).font        // "16px sans-serif"
 * var font = new window.phet.scenery.Font( {
