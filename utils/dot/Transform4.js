...
import Ray3 from '@/utils/dot/Ray3';
...
class Transform4 {
  ...
  invalidate() {
    // sanity check
    window.assert && window.assert(this.matrix.isFinite());
