...
/**
 * Utility functions for Dot, placed into the window.phet.dot.X namespace.
 *
...
const Utils = {
  ...
  distToSegmentSquared(point, a, b) {
    ...
    if (t < 0) {
      ...
      distanceSquared = point.distanceSquared(
  ...
  roundToInterval(value, interval) {
    return Utils.toFixedNumber(
      Utils.roundSymmetric(value / interval) * interval,
