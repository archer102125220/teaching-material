...
const showCommandLineProgress = require('@/utils/chipper/phet-io/common/showCommandLineProgress');
const withServer = require('@/utils/perennial-alias/common/withServer');
 ...
 */
const generatePhetioMacroAPI = (repos, options) => {
  ...
  return withServer(async (port) => {
    ...
    for (let i = 0; i < chunks.length; i++) {
      ...
      options.showProgressBar &&
        showCommandLineProgress(i / chunks.length, false);
